/** Source: https://github.com/vlandham/scroll_demo/blob/gh-pages/js/scroller.js
 ...
 */
 function scroller() {
    ...
    function position() {
      ...
      // lets user scroll within a section
      var prevIndex = Math.max(sectionIndex - 1, 0); // compute how far into a section we are
      var prevTop = sectionPositions[prevIndex];
      var progress = (pos - prevTop) / (sectionPositions[sectionIndex] - prevTop); // we send the value along with the current index in progress
      // @v4 you now `.call` the dispatch callback
